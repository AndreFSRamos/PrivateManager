<template>
  <div>
    ...
    <v-row>
      <v-col cols="12" sm="6"><ChartPieQtdPerPaymentMethods/></v-col>
      <v-col cols="12" sm="6"><ChartPieQtdPerCategories/></v-col>
    </v-row>
    <v-row>
      <v-col cols="12"><ChartLineTotalValueToMonthPerCategories/></v-col>
    </v-row>
  </div>
</template> 
